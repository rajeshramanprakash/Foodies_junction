                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                            <span class="inline-flex rounded-md">
                                <button style="font-weight: 700;"type="button" class="inline-flex items-center   leading-4 font-medium rounded-md text-wheat-500  hover:text-gray-700 focus:outline-none transition"><i class="fas fa-user"></i>&nbsp;
                                    {{ Auth::user()->name }}
